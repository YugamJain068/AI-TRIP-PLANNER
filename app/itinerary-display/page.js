    ...
    <>
      <div>
        <div className="flex p-8 gap-3 overflow-auto scrollbar-hide">
                        ...
                        <div className='flex flex-col flex-1 p-1'>
                          ...
                          {itinerary.hotels.filter(hotel => hotel.city === city.name).map((hotel, idx3) => (
                            <div key={idx3} className="flex flex-row gap-3 mb-2.5 items-center group">
                              ...
                              <span className="relative w-[500px] font-normal overflow-hidden text-ellipsis line-clamp-2 group-hover:whitespace-normal group-hover:max-h-[none] group-hover:bg-white group-hover:shadow-md group-hover:scale-105 group-hover:z-10 transition-all duration-300 ease-in-out group-hover:line-clamp-none">
                                {hotel.notes}
                              </span>
                            </div>
                          ))}
          ...
          <div className="w-[670px] h-[695px] rounded-2xl overflow-hidden sticky top-0 hover:shadow-xl transition-transform hover:scale-[1.01]">
