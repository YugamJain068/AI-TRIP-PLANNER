    ...
    return (
        <div className="relative w-full h-full">
                ...
                {selectedMarker && (
                    ...
                    >
                        <div className="text-sm font-medium">
                            ...
                            <p className="text-xs text-gray-500">{selectedMarker.time}</p>
                        </div>
                    </InfoWindow>
                )}
            </Map>
            ...
            {selectedMarker && (
                ...
                <div className="absolute bottom-4 right-33 z-10 w-[350px] bg-white rounded-xl shadow-xl border border-gray-200 p-4">
